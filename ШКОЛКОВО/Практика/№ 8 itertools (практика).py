...
'-----------------------------------------------------------------------------------------------------------------------'
'''https://3.shkolkovo.online/my/course/7259/dz/30083'''
...
# for i in product(s, repeat=7):
#     g = ''.join(i)
#     if g[0] != '0' and g.count('1') == 1 and g[-1] != '1':
#             q = [int(i) for i in g]
#             if len(set(q)) == 7:
#                 ans += 1
# print(ans)
...
# for el in s:
#     for el2 in s:
#         if el in '0246' and el2 in '0246':
#             k += el + el2
#             bad.append(k)
#             k = ''
#         if el not in '0246' and el2 not in '0246':
#             k += el + el2
#             bad.append(k)
#             k = ''
#
