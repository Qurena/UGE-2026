...
8. Используем черепаху, визуализируя расположение класторов
9. Строим функцию, график которой не проходит через кластеры (лин. прямая / окружность - завасит от задачи)
