...
'''
НЮАНСЫ:
1. "Если процесс B зависит от процесса A,
то процесс B может начать выполнение не раньше,
чем через 3 мс после завершения процесса A", - в формулу в столбце end
мы добавляем условие "+ если(C2=0;0;3)".
'''
'''
...
1-9 пункт предыдущего таска такие же (но сдвиг в пределах 5)
