...
# в первой итерации, когда Петя сделает свой ход, r == 2 (первая итерация r = 3 - 1 = 2)
#                                           all()-any()
# ЕСЛИ r изначально нечетное (побед. Петя), Ваня-Петя
#                                         all()-any()
# ЕСЛИ r изначально четное (побед. Ваня), Петя-Ваня
#
# ИТОГО: победителя в конец!
